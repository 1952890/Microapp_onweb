...
export default function undom() {
	...
	class Element extends Node {
		...
		setAttributeNS(ns, name, value) {
			let attr = findWhere(this.attributes, useToLower(ns, name)),
		...
		removeAttributeNS(ns, name) {
			splice(this.attributes, useToLower(ns, name));
	...
	function createDocument() {
		...
		propAssign(document, document.defaultView = { document, MutationObserver, Document, Node, Text, Element, SVGElement, Event });
		propAssign(document, { documentElement:document, createElement, createElementNS, createTextNode });
